...
describe('winreg', function(){
  ...
  describe('Registry', function (){
    ...
    describe('keyExists()', function(){
      ...
      it('returns a promise if cb is not specified', function(done) {
    ...
    describe('create()', function(){
      ...
      it('returns a promise if cb is not specified', function() {

        var promise = regKey.create();
        test.bool(promise instanceof Promise)
        . isTrue();
    ...
    describe('set()', function (){
      ...
      it('returns a promise if cb is not specified', function() {
        ...
        var promise = regKey.set('SomeString', Registry.REG_SZ, 'SomeValue');
        test.bool(promise instanceof Promise)
        . isTrue();
    ...
    describe('valueExists()', function (){
      ...
      it('returns a promise if cb is not specified', function() {
        ...
        var promise = regKey.valueExists('SomeString');
        test.bool(promise instanceof Promise)
        . isTrue();
    ...
    describe('get()', function (){
      ...
      it('returns a promise if cb is not specified', function() {
        ...
        var promise = regKey.get('SomeString');
        test.bool(promise instanceof Promise)
        . isTrue();
    ...
    describe('remove()', function (){
      ...
      it('returns a promise if cb is not specified', function() {
        ...
        var promise = regKey.remove('SomeString');
        test.bool(promise instanceof Promise)
        . isTrue();
